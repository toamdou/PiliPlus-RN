    ...
    return (
      <View style={[styles.root, { backgroundColor: colors.bg }]}>
        ...
        <View style={styles.emptyWrap}>
          <Text style={[T.headline, { color: colors.text }]}>缺少订阅参数</Text>
        </View>
      </View>
    );
  }
      ...
      <FlashList
        ...
        ListEmptyComponent={
          loading ? null : error ? (
            ...
            <View style={styles.emptyWrap}>
              <View style={[styles.emptyIconBox, { backgroundColor: colors.fill2 }]}>
                <Ionicons name="list-outline" size={38} color={colors.textTertiary} />
              </View>
              <Text style={[T.headline, { color: colors.text }]}>暂无视频</Text>
            </View>
          )
        }
